		...
		<div class="header_top">
			<div class="categories">
				...
				<?php if(is_rtl()) : ?>
					...
					?>
					<div class="toggle <?php ( $selected_category == '' ? print " noleftborder active" : print " noleftborder" ) ?>"><a href="<?php bloginfo( 'url' ); ?>"><?php _e("All posts","outsystems_blog");?></a></div>
